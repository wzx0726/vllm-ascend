...
class AscendMLAImpl(MLAAttentionImpl):
    ...
    def exec_kv_prefill(
        ...
        *,
        ...
        if self.pcp_enabled:
            ...
            local_prefill_start = attn_metadata.pcp_local_prefill_start
            local_prefill_end = attn_metadata.pcp_local_prefill_end
            assert (
    ...
    def _get_num_prefill_kv_tokens(
        ...
        if self.pcp_enabled:
            local_num_input_tokens = attn_metadata.pcp_local_num_input_tokens
            assert local_num_input_tokens is not None, (
                "PCP MLA metadata must be finalized before execution."
            )
